...
//    )
//
//    // Hide bottom bar on auth routes
//    val showBottomBar =
//        currentRoute !in listOf(Destination.LOGIN.route, Destination.REGISTER.route)
//
...
//                startDestination = Destination.HOME.route, // use LOGIN to start on auth
